...
namespace TableForgeDemoFiles
{
    ...
    public class Test1 : ScriptableObject
    {
        ...
        public Dictionary<InnerClass, int> innerClassIntDictionary = new() { { new InnerClass(1, "text1"), 1 }, { new InnerClass(2, "text2"), 2 } };
        public SerializedDictionary<string, int> stringIntDictionary = new() { { "key1", 1 }, { "key2", 2 } };
        public Dictionary<string, InnerClass> stringInnerClassDictionary = new() { { "key1", null }, { "key2", new InnerClass(1, "") } };
        public Dictionary<Vector3, Vector2> structDictionary = new() { { new Vector3(1, 2, 3), new Vector2(1, 2) }, { new Vector3(4, 5, 6), new Vector2(3, 4) } };
        public SerializedDictionary<StructTest, Vector2> structDictionary2 = new() { { new StructTest() { number = 1, boolean = true }, new Vector2(1, 2) }, { new StructTest() { number = 2, boolean = false }, new Vector2(3, 4) } };
    
        public Dictionary<int, InnerClass> hiddenDictionary = new() { { 1, null }, { 2, new InnerClass(2, "text2") } };
    ...
    public class InnerClass
    {
        public int number;
        public string text;
        public List<List<int>> intlList2D = new() { new List<int>() { 1, 2, 3 }, new List<int>() { 4, 5, 6 } };
